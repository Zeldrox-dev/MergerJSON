...
class JSONMergerApp:
    def __init__(self, root):
        ...
        self.source1_button = tk.Button(root, text="Choose Source File 1", command=self.choose_source1)
        self.source1_button.pack(pady=5)
        self.source1_label = tk.Label(root, text="")
        self.source1_label.pack()

        self.source2_button = tk.Button(root, text="Choose Source File 2", command=self.choose_source2)
        self.source2_button.pack(pady=5)
        self.source2_label = tk.Label(root, text="")
        self.source2_label.pack()

        self.final_button = tk.Button(root, text="Choose the name and the directory about final merge file", command=self.choose_final)
    ...
    def choose_final(self):
        self.final_path = filedialog.asksaveasfilename(title="Save the final JSON file", defaultextension=".json", initialdir=".")
